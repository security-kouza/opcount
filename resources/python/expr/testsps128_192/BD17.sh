...
##
## Copyright (c) 2017 - 2019 NTT corp. - All Rights Reserved
##
...
pdbdir="../../pdb"
opcount="../../opcount/opcount.py"
csdlfile=$1
gpfile=$2

case "${csdlfile}" in *.sage)
    sage --preparse "${csdlfile}" || (echo "error: cannot execute sage." >&2 ; exit 1) ;
    csdlfile="${csdlfile}.py" ;;
esac
