...
# This file was *autogenerated* from the file ../../psdl/tightSPS17.sage
...
def POS_Sign(
    ...
    ro = rnd()
    Z  = G**(al-ro*w)
    R  = G**(ro) * product(_sage_const_10 , Mi**(-gami))
...
# //	}
    ...
    b = (
        _sage_const_1 ==e(G, Ah)*e(Z, Gh)*e(R,Ghr)*product(_sage_const_10 , e(Mi,Ghi)) and
        _sage_const_1 ==e(C1z00**(-_sage_const_1 ), Gh)*e(C1x00, Gh)*e(C1z10, Ah)*e(G, rhoh00) and
        _sage_const_1 ==e(C2z00**(-_sage_const_1 ), Gh)*e(C2x00, Gh)*e(C2z10, Ah)*e(Q0, rhoh00) and
        _sage_const_1 ==e(C110**(-_sage_const_1 ), Ehz0)*e(C1z00, Gh)*e(C1y00, Ehs)*e(G, rhoh01) and
        _sage_const_1 ==e(C210**(-_sage_const_1 ), Ehz0)*e(C2z00, Gh)*e(C2y00, Ehs)*e(Q0, rhoh01) and
        _sage_const_1 ==e(C1z01**(-_sage_const_1 ) * (C1z11), D1x21) * e(C1z01* C1z11**(-_sage_const_1 ), D1z21)*
        e(G, pih101)*e(thet101, Gh) and
        _sage_const_1 ==e(C2z01**(-_sage_const_1 ) * C2z11, D1x21) * e(C2z01 * C2z11**(-_sage_const_1 ), D1z21)*
        e(Q1, pih101)*e(thet102, Gh) and
        _sage_const_1 ==e(C1z01**(-_sage_const_1 ) * C1z11, D2x21) * e(C1z01 * C1z11**(-_sage_const_1 ), D2z21)*
        e(G, pih102)*e(thet101, Qh1) and
        _sage_const_1 ==e(C2z01**(-_sage_const_1 ) * C2z11, D2x21) * e(C2z01 * C2z11**(-_sage_const_1 ), D2z21)*
        e(Q1, pih102)*e(thet102, Qh1) and
        _sage_const_1 ==e(C111**(-_sage_const_1 ), Ehz0)*e(C1z01, Gh)*e(C1y01, Ehs)*e(G, rhoh11) and
        _sage_const_1 ==e(C211**(-_sage_const_1 ), Ehz0)*e(C2z01, Gh)*e(C2y01, Ehs)*e(Q1, rhoh11) and
        _sage_const_1 ==e(C111**(-_sage_const_1 ), Ehz1)*e(C1z11, Gh)*e(C1y11, Ehs)*e(G, rhoh12) and
        _sage_const_1 ==e(C211**(-_sage_const_1 ), Ehz1)*e(C2z11, Gh)*e(C2y11, Ehs)*e(Q1, rhoh12) and
        _sage_const_1 ==e(Ez2**(-_sage_const_1 ), D111)*e(G, D1z21)*e(Et, D1y21)*e(rho13, Gh) and
        _sage_const_1 ==e(Ez2**(-_sage_const_1 ), D211)*e(G, D2z21)*e(Et, D2y21)*e(rho13, Qh1)
    )
    return b
